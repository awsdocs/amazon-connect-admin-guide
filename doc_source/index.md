...
+ [Design your contact center in Amazon Connect](architecture-guidance.md)
...
+ [Create Amazon Connect contact flows](connect-contact-flows.md)
   ...
   + [Contact block definitions](contact-block-definitions.md)
      ...
      + [Contact block: Check security status](check-security-status.md)
      ...
      + [Contact block: Set security behavior](set-security-behavior.md)
...
+ [Amazon Connect Wisdom: Get the content you need](amazon-connect-wisdom.md)
