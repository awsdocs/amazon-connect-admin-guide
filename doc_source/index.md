...
+ [Enable Customer Profiles](customer-profiles.md)
   ...
   + [Create and ingest customer data into Customer Profiles by using Amazon S3](customer-profiles-object-type-mappings.md)
      ...
      + [Change behavior of inferred profiles to automatically associate the CTR with one profile found](inferred-profiles-change-behavior.md)
...
+ [Analyze conversations using Contact Lens for Amazon Connect](analyze-conversations.md)
   ...
   + [Investigate issues/call drivers detected in Contact Lens](contact-lens-issue-detection.md)
...
+ [Amazon Connect Glossary](glossary.md)