# Delete an Apple Business Chat integration<a name="delete-apple-business-chat"></a>
...
1. In the **Use case description** box, copy and paste the following template to indicate this is an **delete** request: 
   ...
   ```
   Subject: Delete Apple Business Chat Integration
   Body:
...
![\[Image NOT FOUND\]](http://docs.aws.amazon.com/connect/latest/adminguide/images/abc-sample-delete-ticket.png)
